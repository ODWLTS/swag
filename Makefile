...
BINARY_NAME:=swag
PACKAGES:=$(shell $(GOLIST) github.com/ODWLTS/swag github.com/ODWLTS/swag/cmd/swag github.com/ODWLTS/swag/gen github.com/ODWLTS/swag/format)
