...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/ODWLTS/swag/testdata/global_override/types.Application":  "string",
		"github.com/ODWLTS/swag/testdata/global_override/types.Application2": "github.com/ODWLTS/swag/testdata/global_override/othertypes.Application",
		"github.com/ODWLTS/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
